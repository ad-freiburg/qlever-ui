...
CodeMirror.defineMode("sparql", function(config) {
  ...
  var keywords = wordRegexp(["prefix", "select", "distinct", "from", "where", "order", "limit", "offset",
  							 "optional", "by", "asc", "desc", "as", "avg", "having", "values", "group", "not",
                             "textlimit", "score", "text","contains-entity","contains-word", "occurrences" ,"count",
                             "sample", "min", "max", "average", "concat", "group_concat", "filter"]);
